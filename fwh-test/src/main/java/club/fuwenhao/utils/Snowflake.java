...
//import com.jdcity.jzt.common.enums.ResponseCodeEnum;
...
public class Snowflake {
    ...
    public static String getSnowflakeId() {
        String s = "";
        try {
            s = String.valueOf(Snowflake.getInstanceSnowflake().nextId());
        } catch (Exception e) {
//            throw new BusinessException(ResponseCodeEnum.SERVER_ERROR,"雪花算法出现异常");
        }
        return s;
    }
